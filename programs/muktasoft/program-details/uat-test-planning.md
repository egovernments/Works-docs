...
* Validate end-to-end business flow for each of the identified users flows&#x20;
* All the required fields are present
* The system is accepting only valid values
* Users can save after form filling in all the mandatory fields
...
| Name of participant                     | Project Role/ Designation                | Phone Extension | E-mail                          | <p>Entity </p><p>(ULB/ HUDD/ UMC/ CBO)</p> |
| --------------------------------------- | ---------------------------------------- | --------------- | ------------------------------- | ------------------------------------------ |
...
| <h3>Detailed Functional Scope</h3><p>Employee and CBO Portals are deployed into UAT instance with the features listed below</p> |                                                                                                                                                                                                                                                                                |
| ------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
...
The UAT session will be conducted physically in Bhubaneswar, Odisha at the HUDD office. The detailed plan for the UAT session is as follow:&#x20;
...
* The signoff shall be provided at the end of UAT by HUDD via an email communication or official orders/memo to the eGov.
...
* The mutually agreed defects/CR from UAT will be resolved and demonstrated to users within agreed time frame.
* Post resolution and demonstration of all the issues the application will be ready for the deployment in the production environment&#x20;

### 5.4 UAT Success Criteria&#x20;

* Training on the UAT environment  completed with 100% participation as per the plan. In case some of the participants are not available, prior intimation with reason to be captured.
* No P1 bugs found during the execution of the test scenarios.
* 90% of the total test cases should be executed successfully and the observed behavior was found to match the expected results.
