...
Please refer to this [link for the service builds](../specifications/release-notes/service-build-updates.md) used.
...
Refer to the [section](../specifications/release-notes/service-build-updates.md)[ ](deployment-guide.md#service-builds)for a list of core services to be deployed
...
Refer to the [section](../specifications/release-notes/service-build-updates.md) for a list of MuktaSoft services to be deployed
