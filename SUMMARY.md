  ...
  * [Architecture](platform/architecture/README.md)
    ...
    * [Low Level Design](platform/architecture/low-level-design/README.md)
      ...
      * [Services](platform/architecture/low-level-design/services/README.md)
        * [Projects Service](platform/architecture/low-level-design/services/projects-service/README.md)
          * [Project Technical Docs](platform/architecture/low-level-design/services/projects-service/project-technical-docs.md)
        * [Estimates Service](platform/architecture/low-level-design/services/estimates-service/README.md)
          * [Estimates Technical Docs](platform/architecture/low-level-design/services/estimates-service/estimates-technical-docs.md)
        * [Contracts Service](platform/architecture/low-level-design/services/contracts-service/README.md)
          * [Contracts Technical Docs](platform/architecture/low-level-design/services/contracts-service/contracts-technical-docs.md)
        * [Organisation Service](platform/architecture/low-level-design/services/organisation-service/README.md)
          * [Organisation Technical Docs](platform/architecture/low-level-design/services/organisation-service/organisation-technical-docs.md)
        * [Attendance Management](platform/architecture/low-level-design/services/attendance-management/README.md)
          * [Attendance Technical Docs](platform/architecture/low-level-design/services/attendance-management/attendance-technical-docs.md)
        * [Muster Roll Service](platform/architecture/low-level-design/services/muster-roll-service/README.md)
          * [Muster Roll](platform/architecture/low-level-design/services/muster-roll-service/muster-roll.md)
        * [Expenditure / Billing](platform/architecture/low-level-design/services/expenditure-billing/README.md)
          * [Expense](platform/architecture/low-level-design/services/expenditure-billing/expense.md)
        * [Works Adapter](platform/architecture/low-level-design/services/works-adapter.md)
        * [Measurement Book](platform/architecture/low-level-design/services/measurement-book.md)
        * [Individual Service](platform/architecture/low-level-design/services/individual-service.md)
