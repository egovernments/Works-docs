...
Please make sure that the file[ <mark style="color:purple;">contract-service-persister.yml</mark>](https://github.com/egovernments/works-configs/blob/DEV/egov-persister/contract-service-persister.yml) is present in the **`configs`** repository in the below location.&#x20;
